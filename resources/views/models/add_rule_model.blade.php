    ...
    <article>
        ...
        <div class=" columns two">
            <div class="align-right" style="">
                <a class="button primary"  href="{{ custom_route('general_setting_form') }}">Setting</a>
...
<section class="full-width">
    <article>
            ...
            <div class="columns has-sections card">
             <div class="card-section">
                ...
                <article class="row" style="margin-top:10px">
                    <div class="columns three align-left tab active">
                        <h5>Add Rule</h5>
                    </div>
        ...
        {!! Form::open(['id' => 'add-rule']) !!}
        @if(!empty($rule['id']))
        {!! Form::hidden('rule_id', $rule['id'], ['id' => 'rule_id']) !!}
        @else
        {!! Form::hidden('rule_id','', ['id' => 'rule_id']) !!}
        @endif
        ...
        <div class="row product-hide-show-section" style="display:none;">
            <article>
                ...
                <div class="columns nine alignment">
                    {!! Form::select('product_collection_value[]', [], null, [
        ...
        <div class="row">
            <article>
                ...
                <div class="columns nine align-right">
                    <a href={{ custom_route('home') }} title="Close" class="button secondary login-cancel-btn">Rules</a>
